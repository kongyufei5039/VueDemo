<template>
  <div class="sales-board">
      ...
      <div class="sales-board-form">
          ...
          <div class="sales-board-line">
              ...
              <div class="sales-board-line-right">
                  ...
                  @on-change="onParamChange('versions', $event)"></v-m-chooser>
              </div>
          </div>
          <div class="sales-board-line">
              <div class="sales-board-line-left">
      ...
      <my-dialog :isShowDialog="isShowPayDialog" @close-dialog="closePayDialog">
        ...
        <bank-chooser @on-change="choosBanks"></bank-chooser>
        <div class="button buy-dialog-btn" @click="sumbmited">
          确认购买
        </div>
      </my-dialog>
...
export default {
  ...
  methods: {
    ...
    getPrice () {
      let versionValues = this.versions.map( item => {
        return item.value
      })
    ...
    getVersions: function() {
      let versionsLabel = this.versions.map( item => {
        return item.label
      }).join(',')
      this.versionsLabel = versionsLabel
    },
    choosBanks (bankId) {
      this.bankId = bankId
    },
    sumbmited () {
      ...
      this.$http.post('api/submited', reqParam)
      .then((res) => {
